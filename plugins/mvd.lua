...
plugins = {
    ...
    mvd = {
        ...
        exec_script_on_system_after_recording = '/opt/quake2/plugins/mvd_transfer.sh',
...
function mvd_start_recording()
    ...
    local port = gi.cvar("port", "").string
    ...
    filename = filename.."_"..mapname.."_"..port
        --filename example is team1_team2_urban2_27910
